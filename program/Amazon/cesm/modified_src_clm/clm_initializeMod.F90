...
! !USES:
    ...
    use PrescribedSoilMoisture !!yangx2 added
...
! !REVISION HISTORY:
! Created by Gordon Bonan, Sam Levis and Mariana Vertenstein
! Modified by Xinyi Yang 12/19/2020 (yangx2)
!
! !LOCAL VARIABLES:
!EOP
...
!----------------------------------------------------------------------
  ...
  ! =============================== yangx2 added ===============================
  ! begin
  ! initialze variable for prescribed soil mositure: 
  ! SET "soliliq_2month", "soliice_2month" and "prescibed_mask" : nan

  call prescribedSMini()
  ! end
  ! =============================== yangx2 added ===============================
