...
!-----------------------------------------------------------------------
    ...
    call mpi_bcast (fsoilprescribed,   len(fsoilprescribed),   MPI_CHARACTER, 0, mpicom, ier)  !!yangx2 added
...
!------------------------------------------------------------------------
  ...
  ! =============================== yangx2 added, begin ===============================
  ! Cheching if prescribed soil mositure file exists

     if (fsoilprescribed == ' ') then
       write(iulog,*) '   fsoilprescribed, prescribed soil mositure dataset not set'
    else
       write(iulog,*) '   prescribed soil mositure data   = ',trim(fsoilprescribed)
    end if
