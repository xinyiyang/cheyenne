#!/bin/csh -f
    ...
    set r_end                  = 14
        ...
        # climatology
            ...
            set his_date_start = 197901      # if "season" is DJF, the first month of beginning time should be 12(D) 
...
cat > ${mdir}/code/inside_code/${var}_${season}.ncl << EOF
        ...
        begin
            ; parameters
                ...
                ; observation
                dir_ob      = "/glade/u/home/xinyang/work/datasets/ob/precip.mon.mean.nc"
                fob         = addfile(dir_ob,"r")
                p_ob        = fob->precip    ; unit:mm/day
                p_ob@long_name= ""
                p_ob@units  = ""
                ptime_ob    = p_ob&time
            ...
            ; Plot
                wks     = gsn_open_wks("pdf","${mdir}/pics/${var}_${season}_${scenario_1}_global")             ; open a ps plot
