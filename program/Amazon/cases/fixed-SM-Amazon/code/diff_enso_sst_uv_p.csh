 ...
 # enso composite SSTA, UV, Precip
    ...
    begin
        ; parameters
           ...
           ; input
            ; case_1      
                ...
                fili_sst_1      = "data/${CASE_1}.ocn.${pattern}.${season}.nc"

                fili_uv_p_1     = "data/${CASE_1}.atm.${pattern}.${season}.nc"
            ...
            ; case_2      
                ...
                fili_sst_2      = "data/${CASE_2}.ocn.${pattern}.${season}.nc"

                fili_uv_p_2     = "data/${CASE_2}.atm.${pattern}.${season}.nc"
        ...
        ; PI-control minus Fix-SM-Amazon (f) or reverse
            ...
            p_anom_enso_${season}_mean = fp - p;fp - p + fp_sm -p_sm
        ...
        ; Plot
            wks     = gsn_open_wks("eps","${mdir}/pics/diff_${type}_${pattern}_${season}")             ; open a ps plot
            nplots  = 3
            ...
            ; 1st
                ...
                res1@cnMinLevelValF               = -0.8               ; set min contour level
                res1@cnMaxLevelValF               = 0.8                ; set max contour level
            ...
            ; 2nd
                ...
                vcres1@vcRefAnnoString1           = "2 m/s"              ;"1.5m/s"
                ...
                plot(1)     = gsn_csm_vector_map(wks,u_anom_enso_${season}_mean(::2,::2),v_anom_enso_${season}_mean(::2,::2),vcres1) 
            ...
            ; 3nd
                ...
                res2@cnMinLevelValF               = -3.5               ; set min contour level
                res2@cnMaxLevelValF               = 3.5                ; set max contour level
