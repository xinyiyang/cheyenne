...
set var_name        = WVEL            # TEMP, UVEL, VVEL, PV, PD, SALT
set y_start         = 0001
set y_end           = 0035
...
;************************************************
        ...
        TIME              = var&time
        z_w_top           = var&z_w_top
        z_w_top           = z_w_top*1.E-2       ; convert from cm to m
        z_w_top@long_name = "Depth (T grid)"    ; overwrite long name
        z_w_top@units     = "m"                 ; fix units attribute
...
;-------------------- output to NC file -----------------------------
       ...
       filevardef(outfile,"z_w_top", typeof(z_w_top), getvardims(z_w_top))
       ...
       filevarattdef(outfile,"z_w_top", z_w_top)
