    ...
    begin
        ...
        ; parameters
           ...
           ; input      
            ...
            fili_sst    = "atm/T.interp.$CASE.cam.h0.${timespan}.nc"
        ...
        datafile2 = "${mdir}/data/${CASE}.atm.${type}_${season}.nc"
        system("rm -rf "+datafile2)
        fout2 =addfile(datafile2,"c")
        fout2@title ="composite of sst uv precip"
        filedimdef(fout2,"time",-1,True)

        fout2->t_tran_use=t_tran_use
        fout2->t_shift_${season}_mean=t_shift_${season}_mean
        ...
        ; Plot
            ...
            ; 1st
                ...
                res1@cnMinLevelValF               = 14               ; set min contour level
                res1@cnMaxLevelValF               = 27                ; set max contour level
                ...
                ; Title
                res1@gsnLeftString                = "mean Temp(1000 hPa) and wind(${uvlev} hPa) (${season}) "
