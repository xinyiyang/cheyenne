 ...
 # seasonal composite pattern SSTA, UV, Precip over Amazonia region
    ...
    # set type, time period, lat & lon, dataset, UV level
        # type 
            ...
            set variable   = lnd_var              
        # climatology
            set season     =  JJA                  # MAM, SON, JJA, DJF, ANNUAL
            set season_n   = "0:2"                # 0:2 or 0:11, depending on season or annual mean
    ...
    begin
        ...
        ; ------------------- output data ----------------
        datafile1 = "${mdir}/data/${CASE}.lnd.${type}_${season}.nc"
        system("rm -rf "+datafile1)
        fout1 =addfile(datafile1,"c")
        fout1@title ="lnd component"
        filedimdef(fout1,"time",-1,True)
        fout1->t_tran_use=t_tran_use
        fout1->t_shift_${season}_mean=t_shift_${season}_mean

        fout1->u_tran_use=u_tran_use
        fout1->p_tran_use=p_tran_use

        fout1->u_shift_${season}_mean=u_shift_${season}_mean
        fout1->p_shift_${season}_mean=p_shift_${season}_mean
        ...
        ; Plot
            ...
            ; 1st
                ...
                res1@cnMaxLevelValF               = 45                ; set max contour level
                ...
                ; Title
                res1@gsnLeftString                = " a) Soil Water in top 10cm of soil (kg/m2)(${season}) "
            ...
            ; 2nd
                ...
                ; Shaded
                res2@cnFillPalette                = "BlAqGrYeOrRe"       ; set the color map
                ...
                res2@cnMaxLevelValF               = 140.0                ; set max contour level
                res2@cnLevelSpacingF              = 10                ; set contour spacing 

                ; Title
                res2@gsnLeftString                = " b) Evapotranspiration (W/m2) (${season}) "
                ;res2@gsnLeftStringOrthogonalPosF = -0.001
                res2@gsnStringFontHeightF         = 0.017   
                plot(1) = gsn_csm_contour_map_ce(wks,u_shift_${season}_mean(:,:),res2)
            ...
            ; 3nd
                ...
                ; Shaded
                res3@cnFillPalette                = "BlAqGrYeOrRe"       ; set the color map
                ...
                res3@cnMinLevelValF               = 80.0               ; set min contour level
                res3@cnMaxLevelValF               = 200.0                ; set max contour level
                res3@cnLevelSpacingF              = 10                ; set contour spacing 

                ; Title
                res3@gsnLeftString                = " c) Net Radiative heat flux (W/m2) (${season}) "
                ;res3@gsnLeftStringOrthogonalPosF = -0.001
                res3@gsnStringFontHeightF         = 0.017   
                plot(2) = gsn_csm_contour_map_ce(wks,p_shift_${season}_mean(:,:),res3)
